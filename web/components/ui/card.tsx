...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-[var(--radius-lg)] bg-[var(--surface)] p-5 sm:p-6 md:p-7 shadow-[var(--shadow-soft)]',
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('flex items-center mt-4 pt-4 border-t border-[var(--border)]', className)}
    {...props}
  />
))
